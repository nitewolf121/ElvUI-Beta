...
function AB:Cooldown_OnSizeChanged(cd, width, height)
	...
	if fontScale < MIN_SCALE then
		...
		cd.text:SetFontTemplate(nil, fontScale * FONT_SIZE, 'OUTLINE')
		if cd.enabled then

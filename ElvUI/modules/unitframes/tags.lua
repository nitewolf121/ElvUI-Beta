...
--	Tags
------------------------------------------------------------------------
ElvUF.TagEvents['Elv:threat'] = 'UNIT_THREAT_LIST_UPDATE'
ElvUF.Tags['Elv:threat'] = function(unit)
...
ElvUF.Tags['Elv:health'] = function(unit)
...
ElvUF.Tags['Elv:power'] = function(unit)
	if not unit then return end
...
ElvUF.Tags['Elv:druid'] = function(unit)
	if not unit then return end
...
ElvUF.TagEvents['Elv:diffcolor'] = 'UNIT_LEVEL'
ElvUF.Tags['Elv:diffcolor'] = function(unit)
	if not unit then return end
	local r, g, b
...
ElvUF.TagEvents['Elv:getnamecolor'] = 'UNIT_POWER'
ElvUF.Tags['Elv:getnamecolor'] = function(unit)
	if not unit then return end
...
ElvUF.TagEvents['Elv:nameshort'] = 'UNIT_NAME_UPDATE'
ElvUF.Tags['Elv:nameshort'] = function(unit)
	if not unit then return end
...
ElvUF.TagEvents['Elv:namemedium'] = 'UNIT_NAME_UPDATE'
ElvUF.Tags['Elv:namemedium'] = function(unit)
	if not unit then return end
	local name = UnitName(unit)
	local colorblind = GetCVarBool("colorblindMode")
	if colorblind ~= 1 then
...
ElvUF.TagEvents['Elv:namelong'] = 'UNIT_NAME_UPDATE'
ElvUF.Tags['Elv:namelong'] = function(unit)
	if not unit then return end
	local name = UnitName(unit)
	local colorblind = GetCVarBool("colorblindMode")
	if colorblind ~= 1 then
